...
class DrawingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drawing" do
    assert_difference('Drawing.count') do
      post drawings_url, params: { drawing: { drawing_id: @drawing.drawing_id, parent_id: @drawing.parent_id } }
    end
  ...
  test "should update drawing" do
    patch drawing_url(@drawing), params: { drawing: { drawing_id: @drawing.drawing_id, parent_id: @drawing.parent_id } }
