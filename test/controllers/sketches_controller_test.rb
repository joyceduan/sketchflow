...
class SketchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sketch" do
    assert_difference('Sketch.count') do
      post sketches_url, params: { sketch: { description: @sketch.description, title: @sketch.title, user_id: @sketch.user_id } }
    end
  ...
  test "should update sketch" do
    patch sketch_url(@sketch), params: { sketch: { description: @sketch.description, title: @sketch.title, user_id: @sketch.user_id } }
